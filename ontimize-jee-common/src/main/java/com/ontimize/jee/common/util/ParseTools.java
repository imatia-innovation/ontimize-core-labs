...
public class ParseTools {
	...
	public static boolean parseStringValue(String string, boolean defaultValue) {
		...
		if ("yes".equalsIgnoreCase(string) || "true".equalsIgnoreCase(string)) {
			return true;
		} else if ("no".equalsIgnoreCase(string) || "false".equalsIgnoreCase(string)) {
			return false;
		}
		return defaultValue;
	}
	 ...
	 * @param defaultValue
	 * @return
	 * @deprecated Use {@link com.ontimize.jee.common.tools.ParseUtilsExtended} instead
	 */
	@Deprecated
	public static boolean getBoolean(String s, boolean defaultValue) {
		return ParseUtilsExtended.getBoolean(s, defaultValue);
	}
	...
	public static int getInteger(String s, int defaultValue) {
		return ParseUtilsExtended.getInteger(s, defaultValue);
	}
