...
public class OntimizeHessianExporter extends RemoteExporter implements InitializingBean, HttpRequestHandler {
	...
	public void setExceptionTranslator(final IExceptionTranslator exceptionTranslator) {
	 ...
	 */
	public void invoke(final InputStream inputStream, final OutputStream outputStream) throws Exception {
	 ...
	 * @throws Throwable if invocation failed
	 */
	protected void doInvoke(final HessianSkeleton skeleton, final InputStream inputStream, final OutputStream outputStream)
			throws Exception {

		final ClassLoader originalClassLoader = this.overrideThreadContextClassLoader();
		try {
			InputStream isToUse = inputStream;
			final OutputStream osToUse = outputStream;
