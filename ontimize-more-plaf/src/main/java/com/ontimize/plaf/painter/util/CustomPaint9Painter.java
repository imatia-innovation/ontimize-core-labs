 ...
 */
public class CustomPaint9Painter extends CachedPainter {
    /**
    ...
    public CustomPaint9Painter(int cacheCount) {
        super(cacheCount);
    }
     ...
     */
    public void paint(Component c, Graphics g, int x, int y, int w, int h, Image source, Insets sInsets,
            Insets dInsets, PaintType type, int mask) {
        if (source == null) {
            return;
        }
