...
public class OFormTabbedPaneUI extends BasicTabbedPaneUI implements SynthUI, PropertyChangeListener, TabbedPanePopup {
    ...
    protected SynthContext getContext(JComponent c, Region subregion, int state) {
        ...
        if (subregion == OntimizeRegion.FORM_TABBED_PANE_TAB) {
            if (this.tabStyle == null) {
                this.tabStyle = OntimizeLookAndFeel.getOntimizeStyle(this.tabPane, subregion);
            }
            style = this.tabStyle;
        } else if (subregion == OntimizeRegion.FORM_TABBED_PANE_TAB_AREA) {
            if (this.tabAreaStyle == null) {
                this.tabAreaStyle = OntimizeLookAndFeel.getOntimizeStyle(this.tabPane, subregion);
            }
            style = this.tabAreaStyle;
        } else if (subregion == OntimizeRegion.FORM_TABBED_PANE_CONTENT) {
            if (this.tabContentStyle == null) {
                this.tabContentStyle = OntimizeLookAndFeel.getOntimizeStyle(this.tabPane, subregion);
            }
            style = this.tabContentStyle;
        } else if (subregion == OntimizeRegion.TABBED_PANE_TAB_CLOSE_BUTTON) {
            if (this.tabCloseStyle == null) {
                this.tabCloseStyle = OntimizeLookAndFeel.getOntimizeStyle(this.tabPane, subregion);
            }
    ...
    protected void paintTab(SynthContext tabContext, Graphics g, Rectangle[] rects, int tabIndex, Rectangle iconRect,
        ...
        if (this.tabPane.getTabComponentAt(tabIndex) == null) {
            ...
            Font font = tabContext.getStyle().getFont(tabContext);
            g.setFont(font);
            FontMetrics metrics = OSwingUtilities.getFontMetrics(g);
    ...
    protected void paintText(SynthContext ss, Graphics g, int tabPlacement, Font font, FontMetrics metrics,
        ...
        if (v != null) {
            ...
            FontMetrics fm = OSwingUtilities.getFontMetrics(this.tabPane, g);
            title = OSwingUtilities.clipStringIfNecessary(fm, title, textRect.width);
    ...
    protected class OntimizeTabbedPaneLayout extends TabbedPaneLayout {
        ...
        public void layoutContainer(Container parent) {
            ...
            if (shouldChangeFocus
                    && !OSwingUtilities.tabbedPaneChangeFocusTo(OFormTabbedPaneUI.this.getVisibleComponent())) {
