...
public class OTableHeaderUI extends BasicTableHeaderUI implements PropertyChangeListener, SynthUI {
    ...
    public static class DefaultTableCellHeaderRenderer extends DefaultTableCellRenderer implements UIResource {
        ...
        public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus,
            ...
            if (table != null) {
                ...
                if (header != null) {
                    ...
                    if (hasFocus) {
                        fgColor = getUIColor("TableHeader.focusCellForeground");
                        bgColor = getUIColor("TableHeader.focusCellBackground");                        
                    }
                ...
                if (!isPaintingForPrint && table.getRowSorter() != null) {
                    ...
                    if (sortOrder != null) {
                        switch (sortOrder) {
                            ...
                            case ASCENDING:
                                sortIcon = getUIIcon("Table.ascendingSortIcon");
                                setFont(header.getFont().deriveFont(Font.BOLD));
                                break;

                            case DESCENDING:
                                sortIcon = getUIIcon("Table.descendingSortIcon");
                                setFont(header.getFont().deriveFont(Font.BOLD));
                                break;

                            case UNSORTED:
                                sortIcon = getUIIcon("Table.naturalSortIcon");
                                break;
                        }
                    }
                }
            ...
            if (hasFocus) {
                border = getUIBorder("TableHeader.focusCellBorder");
            }

            if (border == null) {
                border = getUIBorder("TableHeader.cellBorder");
            }
        ...
        /**
         * Gets a Color from UIDefaults with type checking.
         *
         * @param key the UIDefaults key
         * @return the Color value, or null if not found or wrong type
         */
        ...
        /**
         * Gets an Icon from UIDefaults with type checking.
         *
         * @param key the UIDefaults key
         * @return the Icon value, or null if not found or wrong type
         */
        private Icon getUIIcon(String key) {
            Object value = UIManager.get(key);
            return value instanceof Icon ? (Icon) value : null;
        }

        /**
         * Gets a Border from UIDefaults with type checking.
         *
         * @param key the UIDefaults key
         * @return the Border value, or null if not found or wrong type
         */
        private Border getUIBorder(String key) {
            Object value = UIManager.get(key);
