...
public class OntimizeBayeuxServerImpl extends BayeuxServerImpl {
    ...
    protected void initializeAllowedTransports() {
        ...
        if (option == null) {
            ...
            if (this.getAllowedTransports().isEmpty()) {
                throw new IllegalArgumentException("Option '" + BayeuxServerImpl.ALLOWED_TRANSPORTS_OPTION
    ...
    protected void initializeTransports() {
        ...
        if (option == null) {
            ...
            if (this.getTransports().isEmpty()) {
                throw new IllegalArgumentException("Option '" + BayeuxServerImpl.TRANSPORTS_OPTION
    ...
    private ServerTransport newWebSocketTransport() {
        try {
            ...
            if (transport == null) {
                OntimizeBayeuxServerImpl.logger.info("JSR 356 WebSocket classes available, but " + transportClass
