...
public class OntimizeHessianHttpClientConnection extends AbstractHessianConnection {
	...
	private Future<ClassicHttpResponse>	futureResponse;
	...
	public OutputStream getOutputStream() throws IOException {
		...
		final PipedOutputStream os = new PipedOutputStream(snk);
		this.request.setEntity(new InputStreamEntity(snk, ContentType.create("x-application/hessian")));
		this.futureResponse = OntimizeHessianHttpClientConnection.POOL.submit(new Callable<ClassicHttpResponse>() {
	...
	public void sendRequest() throws IOException {
		...
		try {
			this.statusCode = HttpStatus.valueOf(response.getCode());
		...
		default:
			...
			try {
				...
				throw new HessianConnectionException("HessianProxy cannot connect to '" + this.request.getRequestUri(),
						e);
